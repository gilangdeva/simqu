                    ...
                    <div class="col-sm-6 col-xs-12">
                        <h3 class="box-title">REPORT TOTAL INSPEKSI  |  <b style="color: red"> DEPT :
                            @if(isset($report_inspeksi[0]))
                                {{ $report_inspeksi[0]->nama_departemen }}
                            @endif
                            </b>
                        </h3>
                    </div>
                        ...
                        @if(isset($report_inspeksi[0]))
                            ...
                            @foreach($report_summary as $s)
                                <tr style="background-color: #F2F2F2; font-weight:bold;">
                                    <td colspan="4" align="center" style="border-top: 2px solid; border-bottom: 2px solid;">Total</td>
                                    <td style="border-top: 2px solid; border-bottom: 2px solid;">{{ $s->inline }}</td>
                                    <td style="border-top: 2px solid; border-bottom: 2px solid;">{{ number_format(($s->persen_inline), 2,'.','.')  }}%</td>
                                    <td style="border-top: 2px solid; border-bottom: 2px solid;">{{ $s->final }}</td>
                                    <td style="border-top: 2px solid; border-bottom: 2px solid;">{{ number_format(($s->persen_final), 2,'.','.')  }}%</td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
